...
describe("ShareReportModal", () => {
    ...
    it("shows validation error for empty email", async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText("Please enter a clinician email address.")).toBeTruthy();
        });
    });
    ...
    it("shows validation error for invalid email format", async () => {
        ...
        fireEvent.changeText(screen.getByTestId("clinician-email-input"), "invalid-email");
        fireEvent.press(screen.getByTestId("send-button"));
    ...
    it("displays loading state during submission", async () => {
        ...
        fireEvent.changeText(screen.getByTestId("clinician-email-input"), "doctor@example.com");
        fireEvent.press(screen.getByTestId("send-button"));
    ...
    it("shows success message on successful send", async () => {
        mockShareReport.mockResolvedValue("Report successfully sent to doctor@example.com");
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText("Report successfully sent to doctor@example.com")).toBeTruthy();
        });
    });
