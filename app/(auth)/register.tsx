    ...
    <View className="flex-1 w-full items-center">
      <View className="w-full max-w-md px-6 pt-6">
        ...
        <View className="mb-6">
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Image
              ...
              style={{ width: 100, height: 100, marginLeft: 20, marginRight: 12 }}
              resizeMode="contain"
            />
            <View style={{ flexShrink: 1 }}>
              ...
              <Text className="text-gray-600 mt-1" style={{ maxWidth: 190, textAlign: "center" }}>
        ...
        <View className="space-y-3 gap-y-4 w-80 self-center">
          ...
          <View>
            ...
            />
            {emailError ? <Text className="text-red-600 text-xs mt-1">{emailError}</Text> : null}
          </View>
          ...
          <View>
            ...
            <ThemedTextInput
              ...
              secureTextEntry={false}
            />
            {nameError ? <Text className="text-red-600 text-xs mt-1">{nameError}</Text> : null}
          </View>
          ...
          <View>
            ...
            <ThemedTextInput
              ...
              secureTextEntry
            />
            {confirmPasswordError? <Text className="text-red-600 text-xs mt-1">{confirmPasswordError}</Text> : null}
          </View>
        </View>
      ...
      <View className="mt-6 mb-2 w-80 self-center">
        <View className="flex-row items-center">
          ...
          >
            {termsConditions ? <Text className="text-white text-xs">✓</Text> : null}
          </Pressable>

          <Text className="ml-2 text-slate-950 text-sm">
            I agree with the{" "}<Text className="font-bold" onPress={() => Linking.openURL("https://example.com/terms")}> terms and conditions.</Text>
          </Text>
        </View>
      </View>
